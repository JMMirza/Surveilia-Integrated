...
from tsm_model.ops.basic_ops import ConsensusModule
...
class TSN(nn.Module):
    def __init__(
        ...
        self.img_feature_dim = (
            img_feature_dim  # the dimension of the CNN feature to represent each frame
        )
    ...
    def _prepare_base_model(self, base_model):
        ...
        if "resnet" in base_model:
            ...
            from tsm_model.archs.mobilenet_v2 import mobilenet_v2, InvertedResidual
            ...
            self.base_model.avgpool = nn.AdaptiveAvgPool2d(1)
            if self.is_shift:
                from tsm_model.ops.temporal_shift import TemporalShift
                ...
                for m in self.base_model.modules():
                    if (
                        ...
                        if self.print_spec:
                            print(
                                "Adding temporal shift... {}".format(m.use_res_connect)
                            )
